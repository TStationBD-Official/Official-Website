...
Narrow panels (110px desktop / 90px mobile) that slide in from the sides. Visible on all screen sizes — slightly more compact on mobile.
...
.mtag-side-tab {
  ...
  letter-spacing: 0.1em; writing-mode: vertical-lr;
  user-select: none;
}
...
#mtag-side-r .mtag-side-panel { right: 26px; border-right: none; border-radius: 8px 0 0 8px; }
#mtag-side-l .mtag-side-panel { left: 26px; border-left: none; border-radius: 0 8px 8px 0; }
...
/* Mobile — keep side widgets visible, make panels narrower */
@media(max-width:768px){
  .mtag-side-panel { width: 90px; }
  .mtag-side-panel.open { max-width: 90px; padding: 8px; }
  .mtag-side-slide-icon { font-size: 1.1rem; }
  .mtag-side-slide-title { font-size: 0.62rem; }
  .mtag-side-slide-text  { font-size: 0.55rem; margin-bottom: 6px; }
  .mtag-side-slide-btn   { font-size: 0.55rem; padding: 4px 3px; }
  .mtag-side-tab { padding: 10px 6px; font-size: 0.55rem; }
}
</style>

<!-- Right Side Widget -->
<div id="mtag-side-r" class="mtag-side-widget">
  <div class="mtag-side-tab" onclick="mtagToggle('r')">AD</div>
  <div class="mtag-side-panel" id="mtag-panel-r">
    <div class="mtag-side-panel-header">
      <span class="mtag-side-panel-title">Sponsored</span>
      <span class="mtag-ad-chip">AD</span>
    </div>
    <div class="mtag-side-slide active">
...
<div id="mtag-side-l" class="mtag-side-widget">
  <div class="mtag-side-tab" onclick="mtagToggle('l')" style="writing-mode:vertical-lr;transform:rotate(180deg)">AD</div>
...
(function(){
  ...
  rotateSlides('mtag-panel-r');
  rotateSlides('mtag-panel-l');

  // Auto-open both panels after 8 seconds
  setTimeout(function(){ mtagToggle('r'); mtagToggle('l'); }, 8000);
})();
</script>
```
...
- Side widgets show on mobile too but use a narrower panel (90px) with smaller text so they don't block content
